      ...
      <section id="store" className="z-10 w-full mt-12 border-t border-white/10">
        <div className="mx-auto max-w-6xl px-6 md:px-10 py-12">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold tracking-wide text-white">Best Sellers</h2>
            <Link href="/store" className="inline-flex h-10 px-4 items-center justify-center rounded-full border border-[var(--accent)] text-[var(--accent)] hover:bg-[#7f1d1d]/60 transition-colors">See Full Collection</Link>
          </div>
